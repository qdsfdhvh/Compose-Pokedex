...
import com.seiko.pokedex.util.getMutableStateOf
...
private const val SIS_NAME = "sis_name"
private const val SIS_POST = "sis_post"
...
private fun Bundle.toScreen(): Screen {
  return when (val screenName = ScreenName.valueOf(getStringOrThrow(SIS_NAME))) {
